...
require_once __DIR__ . '/../../includes/helpers.php'; // Necesario para header
    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <?php if ($success): ?>
            <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6 text-center">
                ...
                <div class="mt-6">
                    <a href="login.php" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg transition">
                        Volver al Login
                    </a>
                </div>
            </div>
