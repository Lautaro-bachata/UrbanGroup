...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if ($client) {
            // store id in session and redirect to reset page
            $_SESSION['reset_portal_client_id'] = $client['id'];
            header("Location: portal_reset_password.php");
            exit;
        } else {
...
$pageTitle = 'Recuperar Contraseña - Portal';
...
<div class="min-h-screen bg-gray-50 py-12 flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="mt-6 text-center">
            <a href="portal_login.php" class="text-sm text-blue-600 hover:underline">Volver al inicio de sesión</a>
        </div>
    </div>
</div>
